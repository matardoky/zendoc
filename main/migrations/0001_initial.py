# Generated by Django 3.1.6 on 2021-04-05 12:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('uuid', models.UUIDField(db_index=True, default=uuid.uuid4)),
                ('type', models.CharField(choices=[('OUVERTURE RECCURENTE', 'OUVERTURE RECCURENTE'), ('OUVERTURE EXCEPTIONNELLE', 'OUVERTURE EXCEPTIONNELLE')], default='OUVERTURE RECCURENTE', max_length=50)),
