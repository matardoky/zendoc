    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_recurring_period', models.DateTimeField(blank=True, db_index=True, null=True)),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('updated_on', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('type', models.CharField(choices=[('RECCURENCE', ' OUVERTURE RECCURENTE'), ('EXCEPTION', 'OUVERTURE EXCEPTIONNELLE')], default='EXCEPTION', max_length=50)),
        ...
        migrations.AddField(
            model_name='event',
            name='motif',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.motif'),
        ),
        migrations.AddField(
            model_name='event',
            name='rule',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.rule'),
        ),
        migrations.CreateModel(
            name='Base',
            fields=[
